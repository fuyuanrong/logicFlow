...
// 自定义节点的 Model
class EventBasedGatewayModel extends PolygonNodeModel {
	// 设置节点类型
	getNodeType() {
...
// 自定义节点的 View
class EventBasedGatewayView extends PolygonNode {
	// 可以在这里自定义节点的渲染逻辑
}
...
export default {
	...
	view: EventBasedGatewayView,
	model: EventBasedGatewayModel,
	label: '事件网关',
	text: '事件网关',
	icon: '/bpmn-icon/event-based-gateway.svg',
};
